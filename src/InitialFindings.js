...
import distance_from_times_sq_and_age from './BusinessandDistance_time_sq.png';
import distance_from_station_and_age from './distance_from_Station_and_duration.png';
    ...
    due to which I created a bar graph illustrating the distribution of businesses based on their distance
     from Times Square and the nearest train station. The resulting graph is presented below.
            ...
            <div class="col">
                <h3>Assumptions</h3>
                <p>
Based on my findings, it further reinforced my initial assumption that the location of a business plays
   ...
   the age of a business and its distance from Times Square, I realized that my prediction would
    ultimately involve forecasting the "Age" of a business, which could introduce a high degree of error.
     Therefore, I deemed it necessary to establish a clear definition of "Success" first.
            ...
            <p>
Although I lacked access to specific profit records,
...
"Distance from Times Square" and the "Success" of businesses, I developed a visual diagram.
 By utilizing different hues to distinguish between the various types of businesses, I aimed
  to present a clear representation of the data's patterns and insights.
                    ...
                    <p>
                    Based on the visual diagram, several noteworthy observations can be made. Firstly, it is evident that a majority of Electronic Cigarette Dealers are not classified as successful. This trend could be attributed to the recent rise in popularity of electronic cigarettes. As a result, many of these dealers may be relatively young, with less than seven years of operation.

Additionally, there are relatively few successful Laundries. Through research conducted on Facebook listings and group discussions among laundry owners, it was discovered that laundries are often bought and sold on a regular basis. Many individuals utilize laundries as a means of generating consistent income but eventually transition to other business ventures. Consequently, the definition of "success" may not align well with the nature of laundries.

On the other hand, there is a notable presence of successful Stoop Line Stands (groceries without alcohol) within the dataset. This suggests that these types of businesses have achieved a higher level of success.

Furthermore, the visual diagram indicates a significant number of both successful and unsuccessful Tobacco Retail Dealers. During the analysis, it was identified that many tobacco retail dealers advertise themselves as "groceries" or "food establishments" to attract a larger customer base.

Overall, these observations highlight distinct patterns and dynamics within specific business categories, shedding light on the varying degrees of success among them.
                    </p>
                </div>
            ...
            <div class="row">
                ...
                <div class="col">
                    <h3> Types of Successful and Unsuccessful Business</h3>
                       <p> 
Referring to the figure on the right, it provides a clear distinction between the different
